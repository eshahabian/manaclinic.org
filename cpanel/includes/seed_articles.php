...
/**
 * قبلاً «دکتر» را اجباری اول اسم گارسچی می‌گذاشت؛ حذف شد تا ادمین بتواند نام را آزادانه ویرایش کند.
 * (برای نمایش عنوان می‌توان جداگانه در UI برچسب زد.)
 */
function ensure_garsichi_name_has_doctor_prefix(PDO $pdo): void
{
    // no-op — نام در جدول users فقط با ویرایش ادمین/پروفایل عوض می‌شود
}
