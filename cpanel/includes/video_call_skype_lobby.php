...
<aside class="vc-side">
  ...
  <div class="vc-side-brand">
    <img src="<?= e(url('/assets/img/mana-call.png')) ?>?v=20260910b" width="56" height="56" alt="تماس مانا">
  </div>
  <div class="vc-chrome" role="tablist" aria-label="بخش‌های تماس مانا">
    <button type="button" class="vc-chrome-btn is-active" data-vc-tab="home" title="خانه" aria-label="خانه">
      <svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor" aria-hidden="true"><path d="M12 3 4 10v10h6v-6h4v6h6V10z"/></svg>
      <span>خانه</span>
    </button>
    <button type="button" class="vc-chrome-btn" data-vc-tab="calls" title="تماس‌ها" aria-label="تماس‌ها">
      <svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor" aria-hidden="true"><path d="M6.6 10.8c1.4 2.8 3.8 5.2 6.6 6.6l2.2-2.2c.3-.3.7-.4 1-.2 1.1.4 2.3.6 3.6.6.6 0 1 .4 1 1V20c0 .6-.4 1-1 1C10.6 21 3 13.4 3 4c0-.6.4-1 1-1h3.5c.6 0 1 .4 1 1 0 1.2.2 2.5.6 3.6.1.3 0 .7-.3 1l-2.2 2.2z"/></svg>
      <span>تماس‌ها</span>
    </button>
