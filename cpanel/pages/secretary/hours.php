...
?>
<h1>ساعت کاری من</h1>
<p class="muted">ساعت عادی منشی از ۹ صبح تا ۸ شب است؛ قبل از ۹ و بعد از ۸ اضافه‌کار حساب می‌شود. برای هر روز ساعت اولین ورود و آخرین خروج دیده می‌شود؛ «زمان حضور» جمع مدت واقعی هر ورود است (نه فاصلهٔ اول تا آخر). جزئیات هر ورود پشت «بیشتر» است. سال، ماه و روز را از منوی کرکره‌ای انتخاب کنید. اگر ۱۰ دقیقه فعال نباشید خارج می‌شوید.</p>
