...
?>
<h1>ساعت کاری من</h1>
<p class="muted">ساعت عادی منشی از ۹ صبح تا ۸ شب است؛ قبل از ۹ و بعد از ۸ اضافه‌کار حساب می‌شود. برای هر روز ساعت ورود، خروج و زمان حضور از اولین ورود تا آخرین خروج دیده می‌شود؛ جزئیات هر ورود پشت «بیشتر» است. با زدن «کل شهریور» یا «کل مهر» جمع کل همان ماه را می‌بینید. اگر ۱۰ دقیقه فعال نباشید خارج می‌شوید.</p>
