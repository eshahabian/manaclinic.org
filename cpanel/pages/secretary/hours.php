...
?>
<h1>ساعت کاری من</h1>
<p class="muted">ساعت عادی منشی از ۹ صبح تا ۸ شب است؛ قبل از ۹ و بعد از ۸ اضافه‌کار حساب می‌شود. برای هر روز ساعت اولین ورود و آخرین خروج و زمان حضور (از اول تا آخر) دیده می‌شود. لپ‌تاپ/موبایل مدت آنلاین واقعی است؛ اگر وسط روز چندبار قطع شده باشد، همان فاصله جدا نشان داده می‌شود. سال، ماه و روز را از منوی کرکره‌ای انتخاب کنید. اگر ۱۰ دقیقه فعال نباشید خارج می‌شوید.</p>
