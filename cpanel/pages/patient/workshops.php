...
$leads = [
    ...
    'mine' => 'کارگاه‌هایی که عضویت‌شان تأیید شده اینجا هستند. مسیر هفته‌به‌هفته و یادداشت جلسه از همین بخش باز می‌شود. دوره آفلاین با پرسش و پاسخ همگانی داخل همان پنل پخش می‌شود.',
];
