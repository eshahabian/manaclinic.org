...
$urls = [
    ...
    ['loc' => seo_absolute_url('/services'), 'priority' => '0.85', 'changefreq' => 'weekly'],
    ['loc' => seo_absolute_url('/services/individual'), 'priority' => '0.8', 'changefreq' => 'monthly'],
    ['loc' => seo_absolute_url('/services/couples'), 'priority' => '0.8', 'changefreq' => 'monthly'],
    ['loc' => seo_absolute_url('/services/child'), 'priority' => '0.8', 'changefreq' => 'monthly'],
    ['loc' => seo_absolute_url('/services/premarital'), 'priority' => '0.8', 'changefreq' => 'monthly'],
    ['loc' => seo_absolute_url('/services/family'), 'priority' => '0.8', 'changefreq' => 'monthly'],
    ['loc' => seo_absolute_url('/services/assessments'), 'priority' => '0.75', 'changefreq' => 'monthly'],
    ['loc' => seo_absolute_url('/services/workshops'), 'priority' => '0.8', 'changefreq' => 'weekly'],
